...
💬 Um pouco sobre mim, formado em Ciências da Computação e estudante de Engenharia de Software, programador com foco na linguagem Python e suas principais bibliotecas para manipulação, processamento e limpeza de dados para análises com Pandas, Scikit-learn, NumPy, Matplotlib (visualização de dados), também utilizo outras linguagens de programação como Rust e C, SQL e R também fazem parte das minhas competências. 
<br>
<br>
...
<br>
👯 Posso te ajudar com Python, Rust, C, R, Django e/ou Flask.
<br>
